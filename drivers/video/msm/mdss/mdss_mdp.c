...
//BEGIN<REQ><JABALL-1500><20150405>Add store lcd  info;xiongdajun 
#ifdef CONFIG_DEV_INFO
extern int store_lcd_info(const char *const str);
#endif
//END<REQ><JABALL-1500><20150405>Add store lcd  info;xiongdajun 
...
//BEGIN<REQ><JABALL-1500><20150405>Add store lcd  info;xiongdajun 
	...
	} else if(!strncmp(pan_name+i+1, "mdss_dsi_otm1284a_boe_720p_video", sizeof("mdss_dsi_otm1284a_boe_720p_vide"))){
		store_lcd_info("mdss_dsi_otm1284a_720p_video_BOE");
	} else if(!strncmp(pan_name+i+1, "mdss_dsi_nt35521_dj_720p_video", sizeof("mdss_dsi_nt35521_dj_720p_vide"))){
		store_lcd_info("mdss_dsi_nt35521_720p_video_DJ");
	}else{
		store_lcd_info(pan_name+i+1);
	}
#ifdef CONFIG_PROJECT_L9010
	store_lcd_info("mdss_dsi_ea8061v_720p_video");
#endif
#endif
//END<REQ><JABALL-1500><20150405>Add store lcd  info;xiongdajun 
