...
/* Units for temperature below (on x axis) is in 0.1DegC as
   ...
   //BEGIN <> <20150807> <change the ntc para to correct the ADC temprerature error for l5320> panzaoyan
...
#endif
//END <> <20150807> <change the ntc para to correct the ADC temprerature error for l5320> panzaoyan
