...
//Begin <REQ><JABALL-1500><20150615>Add firmware update;xiongdajun
#define JTOUCH  "JTOUCH"
#define TTOUCH  "TTOUCH"
//END <REQ><JABALL-1500><20150615>Add firmware update;xiongdajun
					...
					struct synaptics_rmi4_data *rmi4_data)
{
    ...
    printk(KERN_ERR "fw_image_name is %s\n",rmi4_data->board->fw_image_name);
    //END <REQ><JABALL-1500><20150615>Add firmware update;xiongdajun
	retval = synaptics_rmi4_i2c_read(rmi4_data,
