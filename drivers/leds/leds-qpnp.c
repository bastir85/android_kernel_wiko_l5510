...
//Line<REQ><JABALL-1500><20150403>add breath led;xiongdajun
	int			pwm_channel;
	u32			pwm_period_us;
					...
					const char *name)
{
	...
	//Begin<REQ><JABALL-1500><20150403>add breath led;xiongdajun
	...
	//END<REQ><JABALL-1500><20150403>add breath led;xiongdajun
	if (pwm_cfg->pwm_dev) {
